...
<template>
    ...
    <div class="px-8 py-4" v-else>
        ...
        <div class="flex" v-if="isMyTweet">
                <button @click="isEditing = true" class="flex px-2 rounded-full text-gray-500 hover:text-blue-500 hover:bg-gray-100" title="Go Long">
                        <img src="https://static.thenounproject.com/png/58345-200.png" style="max-width: 30px" alt=""/>
                </button>
                <button @click="onDelete" class="flex px-2 rounded-full text-gray-500 hover:text-blue-500 hover:bg-gray-100" title="Go Short">
